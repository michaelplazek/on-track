...
public class TrainControllerController implements Initializable {
  ...
  public void initializeStatusLabels() {
    currentSpeed.textProperty().setValue("20");
    setSpeed.textProperty().setValue("0");
    authority.textProperty().setValue("0");
  ...
  public void run() {
    ...
    currentSpeed.setText(Integer.toString(Integer.parseInt(currentSpeed.getText()) + 1));
  }
